...
- [ ] Is the price 2,000 AED setup plus 900 AED per qualified call that actually happens, billing from call one and no credit-back — AED only, never both currencies — and not a number invented or negotiated down before she's even objected? (The only other quotable number is 500 AED, The Named Fifty, and only on a live thread.)
...
- [ ] Are BOTH guarantees named — the Empty Chair Guarantee and Five or Free, with its 30-day condition intact? And exactly one true scarcity line ("I run four of these at a time")?
