...
|---|---|---|---|
| `Gate 0 Failed Floors` | multi-select | `Not UAE-based` · `No funnel or paid offer` · `Inactive 30d` · `Audience below floor` | Leads · `Gate 0 Failed Floors` |
...
- `Gate 0 Failed Floors` is a **multi-select of literal floor names** —
  ...
  paid offer`, `Inactive 30d`, `Audience below floor`). A lead can fail
